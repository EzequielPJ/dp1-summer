...
<section id="main">
	...
	<acme:button url="report/reviewer/create.do" type="button" code="report.list.create"/>

	<section id="displayReports">

		<display:table pagesize="5" name="reports" id="report" requestURI="${requestURI}">
			<display:column titleKey="report.list.submission" ><jstl:out value="${report.submission.ticker}"/> </display:column>
