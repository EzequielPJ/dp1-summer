...
public interface ReportRepository extends JpaRepository<Report, Integer> {
	...
	@Query("select r from Report r join r.submission.author authors where authors.id = ?1 and r.submission.notified = true")
	public Collection<Report> findReportsFromAuthor(final int authorId);
