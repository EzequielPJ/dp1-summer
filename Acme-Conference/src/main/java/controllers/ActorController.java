...
public class ActorController extends AbstractController {
	...
	protected ModelAndView createModelAndViewDisplay(final String targetURL) {
		...
		case "CONFERENCESPONSOR":
			final ConferenceSponsor sponsor = this.conferenceSponsorService.findOne(actor.getId());
	...
	protected ModelAndView createModelAndViewEditActor() {
		...
		case "CONFERENCESPONSOR":
			final ConferenceSponsor sponsor = this.conferenceSponsorService.findByPrincipal(LoginService.getPrincipal());
