...
<table>
	<tr>
		<th> <spring:message code="administrator.dashboard.avgGomelas"/> </th>
		<th> <spring:message code="administrator.dashboard.sDGomelas"/> </th>
		<th> <spring:message code='administrator.dashboard.ratioPublishGomelas'/> </th>
		<th> <spring:message code='administrator.dashboard.ratioUnPublishGomelas'/> </th>
	</tr>
	<tr>
		<td> <jstl:out value="${avgOfGomelas}"/>	</td>
		<td> <jstl:out value="${sDOfGomelas}"/>	</td>
		<td> <jstl:out value="${ratioGomelasPublish}"/>	</td>
		<td> <jstl:out value="${ratioGomelasUnPublish}"/>	</td>
