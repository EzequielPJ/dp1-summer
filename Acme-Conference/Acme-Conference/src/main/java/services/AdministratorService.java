...
public class AdministratorService {
	...
	public Double getAvgOfGomelas() {
		Assert.isTrue(AuthorityMethods.chechAuthorityLogged("ADMINISTRATOR"));
		return this.adminRepository.getAvgOfGomelas();
	}

	public Double getSDOfGomelas() {
		Assert.isTrue(AuthorityMethods.chechAuthorityLogged("ADMINISTRATOR"));
		return this.adminRepository.getSDOfGomelas();
	}

	public Double getRatioOfFinalModeVsTotalGomelas() {
		Assert.isTrue(AuthorityMethods.chechAuthorityLogged("ADMINISTRATOR"));
		return this.adminRepository.getRatioOfFinalModeVsTotalGomelas();
	}

	public Double getRatioOfDraftModeVsTotalGomelas() {
		Assert.isTrue(AuthorityMethods.chechAuthorityLogged("ADMINISTRATOR"));
		return this.adminRepository.getRatioOfDraftModeVsTotalGomelas();
	}
